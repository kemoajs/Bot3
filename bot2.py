...
stopuser = {}
token = '7145578076:AAH_5B41CHHVj5RXK7vzimGHwDJC5w6iDwU'
bot=telebot.TeleBot(token,parse_mode="HTML")
admin=1733872542#ايدي الادمن بدون علامات تنصيص
command_usage = {}
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/c_b_c4")
...
𝒀𝑶𝑼𝑹 𝑷𝑳𝑨𝑵 𝑵𝑶𝑾 {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗝𝗢𝗜𝗡 ✨", url="https://t.me/c_b_c4")
		keyboard.add(contact_button)
...
𝘽𝙤𝙩 𝘽𝙮 @c_b_c4''', reply_markup=mes)
...
def start(message):
	def my_function():
		...
		try:
			...
			pas ='KEMO-'+''.join(random.choices(characters, k=4))+'-'+''.join(random.choices(characters, k=4))+'-'+''.join(random.choices(characters, k=4))
			current_time = datetime.now()
